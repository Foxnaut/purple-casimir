...
def PlayGame():
    ...
    def information_page(page_num):
        ...
        while end == False:
            ...
            if page_num == 0:
                ...
                in_game_picture = Image("purple/PygameFoodGame/food-waste.jpg",50,250,980,420)
            if page_num == 1:
                in_game_des = Phrase(0, 0, 0, "Arial", "Increases the income multiplier by 0.5", 50, 200, 30)
                in_game_picture = Image("purple/PygameFoodGame/Irragation.jpg", 50, 250, 980, 420)
            if page_num == 2:
                in_game_des = Phrase(0, 0, 0, "Arial", "Increases food income from clicks by 1", 50, 200, 30)
                in_game_picture = Image("purple/PygameFoodGame/soil.jpg", 50, 250, 980, 420)
            if page_num == 3:
                in_game_des = Phrase(0, 0, 0, "Arial", "Passive income giving food every second", 50, 200, 30)
                in_game_picture = Image("purple/PygameFoodGame/Trackter.jpg", 50, 250, 980, 420)
            ...
            if page_num <= 3:
                ...
                if page_num == 4:
                    ...
                    in_game_picture = Image("purple/PygameFoodGame/How-to-Grow-Broccoli.jpg", 50, 250, 980, 420)
                if page_num == 5:
                    ...
                    in_game_picture = Image("purple/PygameFoodGame/south-sudan.jpg", 50, 250, 980, 420)
                if page_num == 6:
                    ...
                    in_game_picture = Image("purple/PygameFoodGame/Coronavirus-economic-recession.jpg", 50, 250, 980, 420)
                if page_num == 7:
                    ...
                    in_game_picture = Image("purple/PygameFoodGame/crop_failure.jpg", 50, 250, 980, 420)
                ...
                if page_num == 8:
                    ...
                    in_game_des2.draw_text()
                    in_game_picture = Image("purple/PygameFoodGame/drought.jpg", 50, 250, 980, 420)
    ...
    world_image = Image("purple/PygameFoodGame/world_map.jpg",20,20,600,400)
    food_image = Image("purple/PygameFoodGame/broccoli.png",620,10,400,400)
    background_image = Image("purple/PygameFoodGame/background_image.png",0,0,1080,720)

    # X Button

    X_Button = Image("purple/PygameFoodGame/X_Button.png",980,50,50,50)
    ...
    for i in range(4):
        plus_button_image_list.append(Image("purple/PygameFoodGame/plus_image.png",50,505 + (i * 50),30,30))
    ...
    power_up_icon = Image("purple/PygameFoodGame/power_up_icon.png",50,455,30,30)

    green_box = [[],[],[],[]]
    black_box = [[],[],[],[]]
    for i in range(4):
        for j in range(5):
            green_box[i].append(Image("purple/PygameFoodGame/Green_Square.jpg",350 + (j * 40),505 + (i * 50),30,30))
            black_box[i].append(Image("purple/PygameFoodGame/box_outline.png",350 + (j * 40),505 + (i * 50),30,30))

    # Imformation Icon

    info_icon_list = []
    for i in range(4):
        info_icon_list.append(Image("purple/PygameFoodGame/Information_icon.png",550,502.5 + (i * 50),30,30))
    ...
    light_blue_square6 = Image("purple/PygameFoodGame/lightblue.png",0,0,40 + (len(situation_string) * 12),40)
    situation_info_icon = (Image("purple/PygameFoodGame/Information_icon.png",5,5,30,30))
    ...
    heart_list = []
    for i in range(3):
        heart_list.append(Image("purple/PygameFoodGame/Heart.png",780 + (i * 70),570,50,50))

    gray_heart_list = []
    for i in range(3):
        gray_heart_list.append(Image("purple/PygameFoodGame/Heart_Outline.png", 790 + (i * 70), 580, 35, 35))
    ...
    light_blue_square1 = Image("purple/PygameFoodGame/lightblue.png",25,435,570,265)
    light_blue_square2 = Image("purple/PygameFoodGame/lightblue.png",635,435,420,265)
    ...
    light_blue_square3 = Image("purple/PygameFoodGame/lightblue.png",300,200,480,110)
    light_blue_square4 = Image("purple/PygameFoodGame/lightblue.png",350,400,280 + (40 * len(str(final_score1))),110)

    # Start Stuff

    press_spase = Phrase(0, 0, 0,"Arial","Press Space To Play!", 150, 270, 100)
    light_blue_square5 = Image("purple/PygameFoodGame/lightblue.png",150,270,780,120)

    #Brocoli 2

    broccoli_image = Image("purple/PygameFoodGame/broccoli_2.jpg",0,0,1080,720)
    ...
    while main_game == True:
        ...
        if (time.get_ticks() - start_time) / 1000 >= time1:
            ...
            random_picture_list.append(Image("purple/PygameFoodGame/flat_location_logo.png", random_num[0], random_num[1], 40, 40))
        ...
        for i in range(len(random_buttom_list)):
            if random_buttom_list[i].hovering() == "hovering":
                black_box1 = Image("purple/PygameFoodGame/blackbox.jpeg", random_num_list[i][0] + 50, random_num_list[i][1], 110 + len(str(cost_list[i])) * 6, 40)
